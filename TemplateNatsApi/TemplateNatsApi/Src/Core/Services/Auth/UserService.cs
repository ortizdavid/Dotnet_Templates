...
namespace TemplateNatsApi.Core.Services.Auth;
...
public class UserService
{
    ...
    public async Task CreateUser(CreateUserRequest request)
    {
        ...
        _natsPublisher.Publish(Subjects.User.Created, userMessage);
    }
    ...
    public async Task ChangePassword(ChangePasswordRequest request, Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.User.Updated, userMessage);
    }
    ...
    public async Task DeleteUser(Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.User.Deleted, userMessage); 
    }   
