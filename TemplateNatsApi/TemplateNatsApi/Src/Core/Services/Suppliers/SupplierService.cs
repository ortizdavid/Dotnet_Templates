...
namespace TemplateNatsApi.Core.Services.Suppliers;
...
public class SupplierService
{
    ...
    public SupplierService(SupplierRepository repository, ProductRepository productRepository, 
        NatsPublisher rabbitMQProducer, IHttpContextAccessor contextAccessor)
    {
    ...
    public async Task CreateSupplier(SupplierRequest request)
    {
        ...
        _natsPublisher.Publish(Subjects.Supplier.Created, supplier);
    }
    ...
    public async Task UpdateSupplier(SupplierRequest request, Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.Supplier.Updated, supplier);
    }
    ...
    public async Task DeleteSupplier(Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.Supplier.Deleted, supplierDeleted);
    }
    ...
    public async Task ImportSuppliersCSV(IFormFile formFile)
    {
        ...
        _natsPublisher.Publish(Subjects.Supplier.Imported, suppliers);
    }
