...
public class CategoryService
{
    ...
    public CategoryService(CategoryRepository repository, NatsPublisher rabbitMQProducer, IHttpContextAccessor contextAccessor)
    {
    ...
    public async Task CreateCategory(CategoryRequest request)
    {
        ...
        _natsPublisher.Publish(Subjects.Category.Created, category);
    }
    ...
    public async Task UpdateCategory(CategoryRequest request, Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.Category.Updated, category);
    }
    ...
    public async Task DeleteCategory(Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.Category.Deleted, categoryDeleted);
    }
    ...
    public async Task ImportCategoriesCSV(IFormFile formFile)
    {
        ...
        _natsPublisher.Publish(Subjects.Category.Imported, categories);
    }
