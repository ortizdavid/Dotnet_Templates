...
using TemplateNatsApi.Core.Models.Messaging;
...
namespace TemplateNatsApi.Core.Services.Products;
...
public class ProductService
{
    ...
    public ProductService(ProductRepository repository, ProductImageRepository imageRepository, 
        ...
        NatsPublisher rabbitMQProducer, IHttpContextAccessor contextAccessor, IConfiguration configuration)
    {
        _repository = repository;
        _imageRepository = imageRepository;
        _categoryRepository = categoryRepository;
        _supplierRepository = supplierRepository;
        _natsPublisher = rabbitMQProducer;
    ...
    public async Task CreateProduct(ProductRequest request)
    {
        ...
        _natsPublisher.Publish(Subjects.Product.Created, productMessage);
    }
    ...
    public async Task UpdateProduct(ProductRequest request, Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.Product.Updated, productMessage);
    }
    ...
    public async Task DeleteProduct(Guid uniqueId)
    {
        ...
        _natsPublisher.Publish(Subjects.Product.Deleted, product);
    }
    ...
    public async Task ImportProductsCSV(IFormFile formFile)
    {
        ...
        _natsPublisher.Publish(Subjects.Product.Imported, products);
    }
    ...
    public async Task UploadProductImages(Guid uniqueId, IFormFileCollection files) 
    {
        ...
        _natsPublisher.Publish(Subjects.Product.ImageCreated, productImages);
    }
