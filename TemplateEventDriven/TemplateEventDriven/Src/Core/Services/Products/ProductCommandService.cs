...
public class ProductCommandService
{
    ...
    public ProductCommandService(ProductRepository repository, ProductImageRepository imageRepository, 
        CategoryRepository categoryRepository, SupplierRepository supplierRepository,
        EventService<ProductEvent> eventService, IConfiguration configuration)
    {
